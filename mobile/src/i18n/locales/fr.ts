...
const fr: Resources = {
  ...
  family: { title: 'Famille', create: 'Créer une famille', name: 'Nom de la famille', findById: 'Rejoindre une famille', familyId: 'ID de famille', requestJoin: 'Demander à rejoindre', pending: 'En attente de l’acceptation du propriétaire', members: 'Membres', requests: 'Demandes', approve: 'Accepter', reject: 'Refuser', kick: 'Retirer', kickConfirm: 'Retirer ce membre de la famille ?', owner: 'Propriétaire', yourId: 'ID de famille', notFound: 'Famille introuvable' },
  perm: { View: 'Voir', Take: 'Retirer', Deposit: 'Déposer', Manage: 'Gérer' },
  settings: { language: 'Langue' },
  cat: { food: 'Alimentation', groceries: 'Courses', dining_out: 'Restaurants', transport: 'Transport', fuel: 'Carburant', rent: 'Loyer', utilities: 'Charges', electricity: 'Électricité', water: 'Eau', gas: 'Gaz', internet: 'Internet', mobile: 'Mobile', healthcare: 'Santé', medicine: 'Médicaments', education: 'Éducation', tuition: 'Frais de scolarité', clothing: 'Vêtements', shopping: 'Achats', entertainment: 'Loisirs', travel: 'Voyage', gifts: 'Cadeaux', charity: 'Dons', insurance: 'Assurance', household: 'Maison', personal_care: 'Soins personnels', fees: 'Frais', taxes: 'Impôts', other: 'Autre' },
};
export default fr;
