...
const hi: Resources = {
  ...
  auth: { login: 'लॉग इन', register: 'खाता बनाएँ', email: 'ईमेल', password: 'पासवर्ड', confirmPassword: 'पासवर्ड की पुष्टि करें', displayName: 'आपका नाम', noAccount: 'खाता नहींहै? पंजीकरण करें', haveAccount: 'खाता है? लॉग इन करें', passwordHint: 'कम से कम 10 अक्षर' },
